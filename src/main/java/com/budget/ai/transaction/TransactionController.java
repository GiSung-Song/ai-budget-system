...
public class TransactionController {
     ...
     */
    @Operation(summary = "최근 거래 내역 동기화", description = "최근 거래 내역을 동기화합니다.")
    @ApiResponses(value = {
    ...
    @PostMapping("/sync")
    public ResponseEntity<SuccessResponse<Void>> lastSyncTransaction(@AuthenticationPrincipal CustomUserDetails userDetails) {
        transactionService.lastSyncTransaction(userDetails.id());
